<?php include('config.php'); ?>
	...
	$query = mysqli_query($koneksi,"UPDATE mahasiswa SET terakhir_diubah = now() WHERE Nim = '$Nim'");
				...
				if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="halaman_user.php?page=tampil_mhs";</script>';
			}else{
		...
		<form action="halaman_user.php?page=edit_mhs&Nim=<?php echo $Nim; ?>" method="post">
