      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="halaman_admin.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" 
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Mahasiswa <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="halaman_admin.php?page=tampil_mhs">Data Mahasiswa</a></li>
