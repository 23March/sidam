<?php include('config.php'); ?>
	...
	<?php
		...
		if(isset($_POST['submit'])){
			...
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="halaman_user.php?page=tampil_mhs&Nim";</script>';
			}
      else{
...
?>
		...
		<form action="mahasiswa.php?page=tampil_mhs=<?php echo $Nim; ?>" method="post">
